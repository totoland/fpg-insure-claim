...
public class CertificationBean implements Serializable {
    ...
    private String flightDateLabel;
    ...
    public String getFlightDateLabel() {
        return flightDateLabel;
    }

    public void setFlightDateLabel(String flightDateLabel) {
